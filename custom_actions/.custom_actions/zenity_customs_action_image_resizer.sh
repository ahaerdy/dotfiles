...
PICKSIZE=$(zenity --list --radiolist --height "255" --text "<b>Please</b> make a selection:" --hide-header --column "Pick" --column "Item" FALSE "96x96" FALSE "128x128" FALSE "640x480" FALSE "800x600" FALSE "1024x768" FALSE "1280x720" TRUE "1280x960" FALSE "1920x1080")
